...
| 方式 | 說明 | 適用情境 |
|------|------|---------|
| **[資料卷 (Volume) ](../08_data/8.1_volume.md)** | Docker 管理的儲存 | 資料庫、應用資料 |
| **[繫結掛載 (Bind Mount) ](../08_data/8.2_bind-mounts.md)** | 掛載宿主機目錄 | 開發時共享程式碼 |
...
詳細解釋請參考[後臺執行](../05_container/5.2_daemon.md)章節。
...
> 想深入瞭解？請閱讀[底層實現 - 名稱空間](../12_implementation/12.2_namespace.md)。
