...
| 格式 | 含義 | 示例 |
|------|------|------|
| `ip:hostPort:containerPort` | 繫結指定 IP 的特定埠 | `-p 127.0.0.1:8080:80` (僅本機訪問) |
| `ip::containerPort` | 繫結指定 IP 的隨機埠 | `-p 127.0.0.1::80` |
| `hostPort:containerPort` | 繫結所有 IP (0.0.0.0) 的特定埠 | `-p 8080:80` (預設) |
| `containerPort` | 繫結所有 IP 的隨機埠 | `-p 80` |
