...
- [埠對映](9.5_port_mapping.md)：高階埠配置
- [網路隔離](9.6_network_isolation.md)：網路安全與隔離策略
- [EXPOSE 指令](../07_dockerfile/7.9_expose.md)：在 Dockerfile 中宣告埠
- [Compose 網路](../11_compose/11.5_compose_file.md)：Compose 中的網路配置
---
