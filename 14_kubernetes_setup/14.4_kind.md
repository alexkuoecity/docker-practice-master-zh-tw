...
> **版本說明**：本文件基於 Kind v0.31.0 編寫。Kind 會根據下載時的預設行為自動拉取對應的 Kubernetes 版本。建議定期更新 Kind 到最新版本以獲得最新的 Kubernetes 支援。詳見 [Kind Releases](https://github.com/kubernetes-sigs/kind/releases)。
