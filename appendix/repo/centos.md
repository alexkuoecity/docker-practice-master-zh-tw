...
[CentOS](https://en.wikipedia.org/wiki/CentOS) 是流行的 Linux 發行版，其軟體包大多跟 RedHat 系列保持一致。
...
請到 [CentOS 官方映像檔文件目錄](https://github.com/docker-library/docs/tree/master/centos) 檢視。
