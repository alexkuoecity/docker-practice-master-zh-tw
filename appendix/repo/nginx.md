...
[Nginx](https://en.wikipedia.org/wiki/Nginx) 是開源的高效的 Web 伺服器實現，支援 HTTP、HTTPS、SMTP、POP3、IMAP 等協議。
...
請到 [Nginx 官方映像檔文件目錄](https://github.com/docker-library/docs/tree/master/nginx) 檢視。
