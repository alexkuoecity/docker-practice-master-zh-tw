...
> **版本說明：** 本節示例使用 etcd v3.5.29。請訪問 [etcd 官方釋出頁](https://github.com/etcd-io/etcd/releases) 獲取最新版本資訊。

下面我們使用 [Docker Compose](../11_compose/README.md) 模擬啟動一個 3 節點的 `etcd` 叢集。
