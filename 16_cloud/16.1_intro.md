...
> **版本說明**：各雲平臺的容器服務版本更新頻繁。本章示例適用於常見的 Kubernetes API 版本。建議訪問各雲廠商官方文件（如 [AWS EKS](https://aws.amazon.com/eks/)、[Azure AKS](https://azure.microsoft.com/en-us/services/kubernetes-service/)、[Google GKE](https://cloud.google.com/kubernetes-engine)、[阿里雲 ACK](https://www.aliyun.com/product/kubernetes)、[騰訊雲 TKE](https://cloud.tencent.com/product/tke)）獲取最新資訊。
