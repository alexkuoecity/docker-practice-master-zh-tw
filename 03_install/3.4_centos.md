...
Docker 官方當前安裝文件覆蓋的 CentOS 平臺為 **CentOS Stream 9** 和 **CentOS Stream 10**（具體以官方 [安裝文件](https://docs.docker.com/engine/install/centos/) 為準）。Rocky Linux、AlmaLinux 等 RHEL 相容發行版通常可以沿用相近步驟，但建議先在測試環境驗證倉庫與依賴是否匹配。
