...
- **程式語言映像檔** (`golang:1.26-alpine`、`rust:1.95-alpine` 等) 採用次版本標籤，確保 API 穩定性同時獲得安全更新
- **資料庫映像檔** (`postgres:16-alpine`、`redis:8-alpine` 等) 採用大版本標籤，便於獲得修復和改進
...
- 掌握實戰中常見的 DevOps 情境、最佳實踐和故障排查方法

## 章節內容導航

* [DevOps 完整工作流](21.1_devops_workflow.md) — 從程式碼到部署的全流程
* [GitHub Actions](21.2_github_actions.md) — 使用 GitHub Actions 實現 CI/CD
* [Drone](21.3_drone.md) — Drone CI/CD 平臺簡介和配置
* [Drone Demo](21.4_drone_demo.md) — Drone 實戰演示和應用
