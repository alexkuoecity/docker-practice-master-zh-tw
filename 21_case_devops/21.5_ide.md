...
這個模式的優點是“簡單直接、IDE 無關”，缺點是 IDE 需要額外配置
（例如配置遠端直譯器/語言服務，或使用 VS Code Dev Containers）。

### 21.5.3 目錄掛載與許可權建議

* Linux 下如果遇到容器內寫檔案許可權問題，優先確保容器內使用者與宿主機 UID/GID 對齊。
