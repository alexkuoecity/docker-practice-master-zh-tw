...
> **版本說明**：示例使用 `ubuntu:24.04`，這是最新 LTS 版本。推送到私有倉庫時保持了原有的版本標籤，建議生產環境明確指定映像檔版本號。
如果我們退出登入，嘗試推送映像檔。
...
如果你本機佔用了 `443` 埠，你可以配置 [Nginx 代理](https://docs.docker.com/registry/recipes/nginx/)，這裡不再贅述。
