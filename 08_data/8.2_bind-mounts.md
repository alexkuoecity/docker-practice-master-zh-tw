...
> **注意**：Docker Desktop 4.6+ 預設使用 VirtioFS 檔案共享引擎，上述 `:cached`/`:delegated` 選項已被靜默忽略。如需最佳化檔案同步效能，請參考 Docker Desktop 的 [Synchronized file shares](https://docs.docker.com/desktop/synchronized-file-sharing/) 功能。
