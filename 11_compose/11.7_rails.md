...
| `DATABASE_URL` | Rails 12-factor 風格的資料庫配置 |
...
production:
  <<: *default
```
> 💡 使用 `DATABASE_URL` 環境變數配置資料庫，符合 12-factor 應用原則，便於在不同環境間切換。
...
- [Compose 模板檔案](11.5_compose_file.md)：配置詳解
