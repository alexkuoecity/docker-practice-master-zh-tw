...
> **版本說明**：Podman 保持活躍的開發和釋出週期。建議訪問 [Podman 官方文件](https://podman.io/docs) 和 [GitHub Releases](https://github.com/containers/podman/releases) 獲取最新版本。

[Podman](https://github.com/containers/podman) 是一個無守護程序、與 Docker 命令高度相容的下一代 Linux 容器工具。它由 Red Hat 開發，旨在提供一個更安全的容器執行環境。
...
| **映像檔構建** | `docker build` | `podman build` 或 `buildah` |
