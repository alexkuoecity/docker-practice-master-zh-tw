...
> **版本提示：映像檔儲存後端的變遷**
>
> 在 Docker Engine v29 及後續版本中，Docker 在**全新安裝情境**預設啟用 **containerd image store**（替代傳統 classic store 路徑）。這一底層架構級別的變遷，意味著 Docker 解鎖了對 OCI Image Index 和 Attestations（例如原生的 provenance 來源證明與 SBOM 軟體物料清單）的全量本地支援。
